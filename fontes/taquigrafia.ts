...
import type { FuncaoTaquigrafia, NivelDetalhamentoTaquigrafia } from './interfaces-tipos/tipos';

export type { FuncaoTaquigrafia, NivelDetalhamentoTaquigrafia } from './interfaces-tipos/tipos';
